...
cmake -DCMAKE_CXX_COMPILER=mpiicpc                  \
      ...
      -DSIM_TIME=1000                               \
      -DOUT_FREQ=10                     \
      -DYAKL_CUDA_FLAGS="-I /software7/depot/intel-2020/compilers_and_libraries_2020.0.166/linux/mpi/intel64/include -DHAVE_MPI -O3 --use_fast_math -arch sm_70 -ccbin g++ -I${PARALLEL_NETCDF_ROOT}/include -I/software7/depot/hpc_sdk/Linux_x86_64/20.11/math_libs/include" \
      -DCMAKE_EXE_LINKER_FLAGS="-L/software7/depot/hpc_sdk/Linux_x86_64/20.11/cuda/lib64 -L/software7/depot/hpc_sdk/Linux_x86_64/20.11/math_libs/lib64" \
      ..
